...
if __name__ == "__main__":
    ...
    combinations = filter_combinations(
        ...
        DR_methods=[DR_Method.ICA, DR_Method.PCA, DR_Method.Isomap],
        variances=[Variance.V90, Variance.V95]
    )
    
    results_df = train_test_model(models, param_grids, combinations, verbose=True, save_result=True, use_numpy= True, data_process_function=data_processing)
