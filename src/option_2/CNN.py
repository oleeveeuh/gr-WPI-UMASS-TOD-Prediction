...
if __name__ == "__main__":
    ...
    for window in sliding_window_sizes:
        ...
        results_df = train_test_model(models, param_grids, combinations, data_read_function=read_reduced_encoded_file,verbose=True, save_result=True, use_numpy= True, data_process_function=data_processing, windows=True)
        ...
        print(results_df)
        write_results_to_excel(results_df, target_folder=f'performance_sheets_option2/{window_size_map[window]}',verbose=True)